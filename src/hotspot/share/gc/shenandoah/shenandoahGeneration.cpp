...
#undef KELVIN_SEES
  ...
  log_info(gc)("%s: available(" SIZE_FORMAT "), in_use: " SIZE_FORMAT " = used: " SIZE_FORMAT " + humongous_waste: " SIZE_FORMAT
               " returns " SIZE_FORMAT,
               name(), capacity, in_use, used(), get_humongous_waste(), result);
#endif
